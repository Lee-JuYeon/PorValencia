...
import com.cavss.porvalencia.databinding.SheetMapFoodBinding
...
class BottomSheetFood(
    context: Context,
    private val setModel: FoodDTO
) {

    private val binding: SheetMapFoodBinding = DataBindingUtil.inflate(
        LayoutInflater.from(context),
        R.layout.sheet_map_food,
        null,
        false
    )
